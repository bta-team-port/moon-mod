...
public final class BiomeProviderMoon extends BiomeProvider {
	...
	public BiomeProviderMoon(long seed, WorldType worldType) {
	...
	public static void init() {
		brm.clear();
		brm.addRange(MoonBiomes.LUNAR_PLAINS, new BiomeRange(0.00, 1.00, 0.00, 1.00, 0.00, 1.00, 0.00, 1.00));
		brm.lock();
	}
}
